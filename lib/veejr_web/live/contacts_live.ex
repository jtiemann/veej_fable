        ...
        <.header>
          ...
          <:actions>
            ...
            >
              ...
              <button
                id="contacts-theme-bubblegum"
                type="button"
                data-contacts-theme-option="bubblegum"
                aria-pressed="false"
                class="contacts-theme-option rounded-full px-3 py-1.5 text-xs font-medium transition"
              >
                Bubblegum
              ...
              <button
                id="contacts-theme-aurora"
                type="button"
                data-contacts-theme-option="aurora"
                aria-pressed="false"
                class="contacts-theme-option rounded-full px-3 py-1.5 text-xs font-medium transition"
              >
                Aurora
              ...
              <button
                id="contacts-theme-arcade"
                type="button"
                data-contacts-theme-option="arcade"
                aria-pressed="false"
                class="contacts-theme-option rounded-full px-3 py-1.5 text-xs font-medium transition"
              >
                Arcade
